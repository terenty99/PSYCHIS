...
export const CLUSTER_COLOR_PALETTES = {
  stone: {
    id: 'stone',
    name: 'Warm Concrete',
    accent: '#78716C',
    ...
    stroke: 'rgba(197, 194, 188, 0.9)',
    strokeDark: 'rgba(120, 113, 108, 0.85)',
    isoline: 'rgba(168, 162, 158, 0.45)',
  ...
  amber: {
    ...
    accent: '#D97706',
    accentDark: '#92400E',
    fill: 'rgba(254, 243, 199, 0.42)',
    stroke: 'rgba(217, 119, 6, 0.75)',
    strokeDark: '#B45309',
    isoline: 'rgba(245, 158, 11, 0.45)',
  ...
  emerald: {
    ...
    accent: '#059669',
    accentDark: '#065F46',
    fill: 'rgba(209, 250, 229, 0.40)',
    stroke: 'rgba(5, 150, 105, 0.75)',
    strokeDark: '#047857',
    isoline: 'rgba(16, 185, 129, 0.45)',
  ...
  blue: {
    ...
    strokeDark: '#1D4ED8',
    isoline: 'rgba(59, 130, 246, 0.45)',
    pillBg: 'rgba(239, 246, 255, 0.96)',
    pillBorder: '#93C5FD',
    badgeBg: '#DBEAFE',
    badgeText: '#1E40AF',
  ...
  purple: {
    id: 'purple',
    name: 'Violet Manifold',
    accent: '#7C3AED',
    accentDark: '#5B21B6',
    fill: 'rgba(237, 233, 254, 0.40)',
    stroke: 'rgba(124, 58, 237, 0.75)',
    strokeDark: '#6D28D9',
    isoline: 'rgba(139, 92, 246, 0.45)',
  ...
  rose: {
    ...
    accent: '#E11D48',
    accentDark: '#9F1239',
    fill: 'rgba(255, 228, 230, 0.40)',
    stroke: 'rgba(225, 29, 72, 0.75)',
    strokeDark: '#BE123C',
    isoline: 'rgba(244, 63, 94, 0.45)',
  ...
  teal: {
    ...
    accent: '#0D9488',
    accentDark: '#115E59',
    fill: 'rgba(204, 251, 241, 0.40)',
    stroke: 'rgba(13, 148, 136, 0.75)',
    strokeDark: '#0F766E',
    isoline: 'rgba(20, 184, 166, 0.45)',
    pillBg: 'rgba(240, 253, 250, 0.96)',
    pillBorder: '#5EEAD4',
    badgeBg: '#CCFBF1',
    badgeText: '#115E59',
  ...
  orange: {
    ...
    strokeDark: '#C2410C',
    isoline: 'rgba(249, 115, 22, 0.45)',
    pillBg: 'rgba(255, 247, 237, 0.96)',
    pillBorder: '#FDBA74',
    badgeBg: '#FFEDD5',
    badgeText: '#9A3412',
...
export function getClusterColor(colorKey) {
  return CLUSTER_COLOR_PALETTES[colorKey] || CLUSTER_COLOR_PALETTES.stone;
}
